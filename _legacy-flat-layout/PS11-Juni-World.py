...
print(
	"Welcome to Juni World! We have a large selection of rides for you to ride! We'll even help you keep track of how much time you have left in the park after each ride!\n")
