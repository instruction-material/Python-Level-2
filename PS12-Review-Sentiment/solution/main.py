pos_words = ["good", "great", "excellent", "awesome", "beautiful", "amazing", "glad", "joy", "happy", "positive", "cool"]

neg_words = ["bad", "mediocre", "poor", "lousy", "sad", "unacceptable", "awful","negative", "inferior", "lame", "disappointing"]
...
print ("The review has " + str(perc_pos) + " percent positive words and " + str(perc_neg) + " percent negative words.")
