...
if num_tickets < lollipop_price and num_tickets < action_figure_price and num_tickets < tshirt_price and num_tickets < stuffed_animal_price:
  print("You can't afford anything by yourself")
if num_tickets >= lollipop_price:
  print("You can buy a lollipop, but you'll only have " + str(num_tickets - lollipop_price) + " tickets left")
if num_tickets >= action_figure_price:
  print("You can buy an action figure, but you'll only have " + str(num_tickets - action_figure_price) + " tickets left")
if num_tickets >= tshirt_price:
  print("You can buy a t-shirt, but you'll only have " + str(num_tickets - tshirt_price) + " tickets left")
if num_tickets >= stuffed_animal_price:
  print("You can buy a stuffed animal, but you'll only have " + str(num_tickets - stuffed_animal_price) + " tickets left")
