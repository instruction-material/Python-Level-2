...
print("Welcome to the Wheel of Fortune! You have " + str(num_guesses_remaining) + " guesses to figure out the correct word. Good luck!")
...
while True:
  ...
  # ask for a guess
  guessed_letter = input("Guess a letter! You have " + str(num_guesses_remaining) + " guesses remaining.")
